...
$("#dodajAutomobilForm").submit(function () {
  ...
  request.done(function (response, textStatus, jqXHR) {
    if (response == "Success") {
      ...
      console.log("Automobil nije dodat" + response);
      alert(response);
    }
  });
...
$("#dodajIzvestaj").submit(function () {
  ...
  request.done(function (response, textStatus, jqXHR) {
    if (response == "Success") {
      ...
      console.log("Izvestaj nije dodat" + response);
      alert(response);
    }
  });
...
function proveriDatum() {
  ...
  request.done(function (response, textStatus, jqXHR) {
    if (response == "UNET") {
      ...
      document.querySelector("#btnPosaljiIzvestaj").innerHTML =
        "Izvestaj je vec poslat!";
      document
        .getElementById("btnPosaljiIzvestaj")
        .setAttribute("disabled", "disabled");
    } else {
      console.log("Neuspeh" + response);
    }
  });
