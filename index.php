...
if(isset($_POST['username']) && isset($_POST['password'])){
    ...
    while($red = $rezultat->fetch_array()):
        ...
        if($red["Korisnicko_Ime"] == $uname){
            $_SESSION['user_id'] = $red["Radnik_ID"];
        }
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 30vh;">
                ...
                <div class="col-md-6" id="logInDiv">
                    <h3 style="margin-bottom: 30px; margin-top: 15px; text-align: center;">Login</h3>
                <form action="#" method="POST">
                    <div class="container">
                        ...
                        <button type="submit" class="btnSubmit btn-primary" name="submit">Prijavi se</button>
                    </div>
                </form>
                </div>
