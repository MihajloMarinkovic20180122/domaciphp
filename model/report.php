...
class Report{
    ...
    {
        $query = "SELECT * FROM izvestaji";
        return $conn->query($query);
    }

    public static function add(Report $report, mysqli $conn)
    {
        $query = "INSERT INTO izvestaji(izvestaj_id,datum_izvestaja,izvestaj,uneo) VALUES('NULL','$report->datum_izvestaja','$report->izvestaj','$report->uneo')";
        return $conn->query($query);
    }

    public function deleteById(mysqli $conn)
    {
        $query = "DELETE FROM izvestaji WHERE izvestaj_id=$this->izvestaj_id";
        return $conn->query($query);
    }
    
    public static function getById($id, mysqli $conn){
        $query = "SELECT * FROM izvestaji WHERE izvestaj_id=$id";
